 ...
 * @author wq
 */
public class TxtTheme implements Theme {

    private static TxtTheme instance;
    ...
    public static Theme getInstance() {
        if (instance == null) {
            synchronized (TxtTheme.class) {
                if (instance == null) {
                    instance = new TxtTheme();
                }
            }
        }
        return instance;
    ...
    public String getMethodPath() {
        return "template/txt/Method.txt";
    }

    @Override
    public String getParamContentPath(boolean returnParam) {
        if (returnParam) {
            return "template/txt/ReturnParamContent.txt";
        }
        return "template/txt/ParamContent.txt";
    }

    @Override
    public String getParamTitlePath(boolean returnParam) {
        if (returnParam) {
            return "template/txt/ReturnParamTitle.txt";
        }
        return "template/txt/ParamTitle.txt";
    }
